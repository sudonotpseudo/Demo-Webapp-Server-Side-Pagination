...
export default function Project() {
  ...
  const onTableChange = (type, newState) => {
    ...
    const getData = async (newState) => {
      try {
        let endpoint_uri = `/api/files?project_id=`+projectId+`&page=`+newState.page+`&page_size=`+newState.sizePerPage+`&sort=`+newState.sortField+`&sort_type=`+newState.sortOrder
